...
def model_param_variants():
    return {
        ...
        "radar         .point_cloud_encoder_kwargs.num_layers": [1, 2, 3, 4, 5],
        "fancy_infrared.point_cloud_encoder_kwargs.num_layers": [1, 2, 3, 4, 5],
        "radar         .point_cloud_encoder_kwargs.num_heads": [4, 8, 16, 32],
        "fancy_infrared.point_cloud_encoder_kwargs.num_heads": [4, 8, 16, 32],
        "radar         .point_cloud_encoder_kwargs.pooling_strategy": ["mean", "cls"],
        "fancy_infrared.point_cloud_encoder_kwargs.pooling_strategy": ["mean", "cls"],
        ...
        "fancy_infrared.downsampler_kwargs.output_dim": [None, 16, 32, 64, 128, 256],
...
def filter_params(params: dict, model_type: str = "", n: int = None):
    ...
    if n is not None:
        ...
        filtered_params = dict(filtered_params[:n])
